...
namespace PassportWebApplication.Controllers
{
    ...
    [ApiController]
    public class RenewApplicationController : ControllerBase
    {
        private readonly IUnitofWork _unitofWork;
        private readonly PassportContext _context;
        private readonly IMapper _mapper;
        public RenewApplicationController(IUnitofWork unitofWork, PassportContext context, IMapper mapper)
        {
        ...
        [HttpPost("renewapplication")]
        public async Task<IActionResult> ApplyForReNewApplication(NewApplicationDto newApplicationDto)
        {
            try
            {
                ...
                newApplication.InItRenewMasterData(newApplicationDto);
