...
import { ApplicationStatus, ApplicationType, ChangeInAppearance, Citizenship, Country, EducationalQualification, EmployeementType, Gender, MaritalStatus, PagesRequried, PassportType, ReasonforRenewal, State, ValidityRequired } from '../../../core/enums/newapplicationenums';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, RouterOutlet, FooterComponent, ReactiveFormsModule, CommonModule, HeaderComponent],
  templateUrl: './renew-application.component.html',
  styleUrl: './renew-application.component.css'
})
export class RenewApplicationComponent implements OnInit {
  ...
  reissueReasons = this.convertEnumToKeyValueArray(ReasonforRenewal);
  changeInExistingReasons = this.convertEnumToKeyValueArray(ChangeInAppearance);
  ...
  private initializeForms(): void {
    ...
    this.applicantForm = this.fb.group({
      ...
      previousPassportNumber:['',[Validators.required]],
  ...
  onSubmit(): void {
    if (this.serviceRequestForm.valid && this.applicantForm.valid &&
      ...
      if (typeof serviceRequiredDto.applicationType === 'string' && 
          ...
          typeof serviceRequiredDto.reasonforRenewal === 'string' &&
          typeof serviceRequiredDto.changeInAppearance === 'string') {
        ...
        serviceRequiredDto.reasonforRenewal = parseInt(serviceRequiredDto.reasonforRenewal, 10) || 0;
        serviceRequiredDto.changeInAppearance = parseInt(serviceRequiredDto.changeInAppearance, 10) || 0;
      }
      ...
      applicntDetailsDto.isAliases = isAliasesvalue === 'true';
      applicntDetailsDto.isChangedName = isChangedNamevalue === 'true';
      applicntDetailsDto.isParentOrSpouceGovermentServent = isParentOrSpouceGovermentServentvalue === 'true';
      applicntDetailsDto.isNonEcrEligible = isNonEcrEligiblevalue === 'true';
      ...
      otherDetailsDto.isCriminalProceedings = isCriminalProceedings === 'true';
      otherDetailsDto.isWarrantSummons = isWarrantSummons === 'true';
      otherDetailsDto.iArrestWarrant = iArrestWarrant === 'true';
      otherDetailsDto.isDepartureOrder = isDepartureOrder === 'true';
      otherDetailsDto.iConviction = iConviction === 'true';
      otherDetailsDto.isPassportRefusal = isPassportRefusal === 'true';
      otherDetailsDto.isPassportImpounded = isPassportImpounded === 'true';
      otherDetailsDto.ispassportRevoked = ispassportRevoked === 'true';
      otherDetailsDto.isForeignCitizenship = isForeignCitizenship === 'true';
      otherDetailsDto.isotherPassport = isotherPassport === 'true';
      otherDetailsDto.isSurrenderedPassport = isSurrenderedPassport === 'true';
      otherDetailsDto.isRenunciation = isRenunciation === 'true';
      otherDetailsDto.isEmergencyCertificate = isEmergencyCertificate === 'true';
      otherDetailsDto.isDeported = isDeported === 'true';
      otherDetailsDto.isRepatriated = isRepatriated === 'true';
      ...
      this.formDataService.saveRenewApplication(applicationData).subscribe(
        (response) => {
